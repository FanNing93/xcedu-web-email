  ...
  <section class="layout-list-content padding-top-size-nomal padding-bottom-size-nomal">
    ...
    >
      ...
      <el-form-item v-if="isCopy" label="抄送人" prop="copySend">
        <el-row>
          <el-col :span="24">
            <chooseUser ref="copySend" v-model="form.copySend" :allow-write="true" :select-role="roles" />
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item v-if="isSecrte" label="密送人" prop="secretSend">
        <el-row>
          <el-col :span="24">
            <chooseUser ref="secretSend" v-model="form.secretSend" :allow-write="true" :select-role="roles" />
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="附件上传">
        <fileUp ref="fileup" :accept="`image/*`" :accept-tips="`只能上传图片格式的文件`" :dir="`dir`" />
      </el-form-item>
...
<script>
import { createEmail, updateEmailById, getEmailById } from '@/api/index'
